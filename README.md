...
1. Upload `marketing-cloud-account-engagement-for-wordpress/trunk` to your `/wp-content/plugins/` directory or go to Plugins > Add New in your WordPress Admin area and search for Account Engagement.
